...
/**
 * 继承SmartRecyclerViewAdapter的提供拖拽操作的抽象baseAdapter类SmartRecyclerViewDragAdapter
 * @author alexlee1987
 * @version 1.0.0
 * @time 2019/09/28
 */
public abstract class SmartRecyclerViewDragAdapter<T> extends SmartRecyclerViewAdapter<T> {
    ...
    public SmartRecyclerViewDragAdapter(List<T> data, Context context, int... layoutId) {
        super(data, context, layoutId);
    }

    public SmartRecyclerViewDragAdapter(Context context, int... layoutIds) {
        super(context, layoutIds);
    }

    public SmartRecyclerViewDragAdapter(List<T> mList, Context context) {
        super(mList, context);
    }
